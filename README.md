# えひめAEDレスキューマップ — v1.0.0 / Precision Model v2
...
- **詳しい使い方**: [`docs/USAGE.md`](docs/USAGE.md)
- **v1.0.0の分析条件・代表結果**: [`docs/RELEASE_v1.0.0.md`](docs/RELEASE_v1.0.0.md)
- **ドキュメント一覧**: [`docs/INDEX.md`](docs/INDEX.md)

基本操作は、公開ページで短時間アクセス距離を選び、「全AED / 24時間利用可のみ」を切り替え、カバー率・未カバー人口・75歳以上未カバー・「次の1台」を確認します。初期値320mは歩行速度4.8km/hで片道約4分相当の分析設定であり、医学的基準ではありません。

## Precision Model v2で変わったこと

初版の「44地域人口を公共施設位置へ均等配分」「直線距離」を廃止し、次のモデルへ置き換えました。
...
デフォルト条件: 320m、歩行速度4.8km/h相当、2020年簡易100m人口、OSM歩行ネットワーク。
...
完全な固定条件とQA結果は [`docs/RELEASE_v1.0.0.md`](docs/RELEASE_v1.0.0.md) を参照してください。
